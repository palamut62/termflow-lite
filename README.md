...
| Platform | Artifacts |
| --- | --- |
| Windows | `TermFlow-Lite-1.8.0-x64.exe` (installer) · `TermFlow-Lite-1.8.0-x64.zip` (portable) |
| Linux | `TermFlow-Lite-1.8.0-x86_64.AppImage` · `TermFlow-Lite-1.8.0-amd64.deb` |
